    ...
    <>
      <header className="user-profile-header26">
        ...
        <div className="profile-links26">
          <a href={JSON.parse(localStorage.getItem('user')).link_facebook}><i className="fab fa-facebook"></i>Facebook</a>
          <a href={JSON.parse(localStorage.getItem('user')).link_linkdin}><i className="fab fa-linkedin"></i>Linkedin</a>
        </div>
