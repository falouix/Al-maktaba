          ...
          const data={
              ...
              try {
                const response = await axios({
                  method: "post",
                  url: Environment.api_url+'dashboard.php',
                  data: selectedFile,
    ...
    return(
     <div class="blog_post">
      ...
      >
        ...
        <button class="thm-btn btn_custom_close" onClick={closeModal}>X</button>
        <form>
        ...
        <div class="container_copy">
          ...
          <button onClick={openModal} class="thm-btn" ><span>Ajouter Photos</span></button>
          <button onClick={openModal} class="thm-btn" ><span>Ajouter PDF</span></button>
          <button class="thm-btn" onClick={(event)=>createStatus(event)} >
           <span><BiShare /></span> 
            </button>
          </div>
        </div>
