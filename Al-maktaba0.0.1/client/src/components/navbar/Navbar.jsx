  ...
  return ( 
    ...
    <nav className="nav custom_adds">
      ...
      <input type="checkbox" id='checkleft'/>
        <label for="checkleft" class="checkbtnleft">
      ...
      <div className="search_container">
        ...
        <a href="/bibliotheque">
          <RiBookMarkFill class='icons'></RiBookMarkFill>
          <span>Biblio</span>
        </a>
        </li>
        <li className="navbarli">
        <a href="/messanger">
        <RiMessage3Fill class='icons'></RiMessage3Fill>
          <span>Message</span>
        </a>
        </li>
        <li className="navbarli">
          <a href="/notification">
          <RiNotification2Fill class='icons'></RiNotification2Fill>
                      <span>Notif</span>
        ...
        <li className="navbarli">
          <a href="/profile">
          <RiUser3Fill class='icons'></RiUser3Fill>
          <span>Profile</span>
          </a>
        </li>
        <li className="navbarli">
          <a href="/options">
          <RiMenuLine class='icons'></RiMenuLine>
            <span>Options</span>
          </a>
        </li>
