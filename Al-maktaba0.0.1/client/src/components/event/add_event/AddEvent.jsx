...
function AddEvent(eventToCreate){
   ...
   const handleChangeDateEndtEvent = (event) => {
        ...
        console.log({
         ...
         axios.post(Environment.api_url+'events.php',{
            ...
            console.log(res)
              ...
              await axios.post(`https://www.apialmaktaba.inspira-jendouba.org/almaktaba_api/events.php?action=upload_file&insert_id=`+res.data.insert_id,
                      formDatabanner_file,{
                        headers: {
    ...
    return(
        ...
        <div class="Book-box12">
        <div class="right12">
        <h1>Créer Un Évènement</h1>
        <label>Nom D'Événement</label>
        <input type="text" class="input-field-event12" onChange={(e)=>{
                                handleChangenameEvent(e);
                              }}/>
        <label>Description</label>

        <textarea type="text" rows="6" class="input-field-description13" placeholder='Décrivez Votre événement'
                            onChange={(e)=>{
                              handleChangeDescriptionEvent(e);
                              }}/>
        <label>Ajouter Un Lien D'inscription</label>
        <input type="text" class="input-field-event12" placeholder='Exemple Lien Google form' onChange={(e)=>{
        ...
        <h2>Ajouter Une Photos Pour L'événement</h2>
          ...
          <span><input type='file' class="thm-btn margin_top_5 btn_file_event" onChange={(e)=>{
                                console.log(1111)
      ...
      <label>Choisir La Date de début de Votre Évènement </label>
        ...
        <button class="thm-btn margin_top_5" onClick={(e)=> createEnvent(e)}><span>Créer</span></button>
