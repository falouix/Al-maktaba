...
<div class="about-us29 ">
    ...
    <div class="content29">
        ...
        <button class="thm-btn29"><a href="#"><span>Plus D'informations</span></a></button>   
</div>
</div>
<div class= "heading29 margin_bottom_50">
    <h1>CONTACT</h1>
        <div class="contact-box29">
            <h2>Envoyer Nous Un Message</h2>
            <input type="text" class="field29" placeholder="Nom" />
            <input type="text" class="field29" placeholder="Adresse E-mail" />
            <input type="text" class="field29" placeholder="Numéro Telephone" />
            <textarea placeholder="Message" class="field29"></textarea>
            <button class="thm-btn29 custom_adds_btn"><span>Envoyer</span></button> 
        </div>
    </div>
